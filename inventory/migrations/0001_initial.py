    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('kg', 'Kilogramos'), ('g', 'Gramos'), ('l', 'Litros'), ('ml', 'Mililitros'), ('u', 'Unidades'), ('doc', 'Docenas'), ('paq', 'Paquetes')], default='u', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movement_type', models.CharField(choices=[('purchase', 'Compra'), ('usage', 'Uso/Consumo'), ('adjustment', 'Ajuste'), ('waste', 'Desperdicio'), ('return', 'Devolucion')], max_length=20)),
